...
public class MainActivity extends ActionBarActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mInput = (Button) findViewById(R.id.m_input);
        ...
        //TODO: Remember that when entering m_input, the activity detection is still active.
    ...
    // Magnus
    public static final String EXTRA_MESSAGE = "com.google.android.gms.location.sample.activityrecognition.MESSAGE";
    //TODO: remove the
    public void sendMessage(View view) {
        Intent intent = new Intent(this, InputPage.class);
        //EditText editText = (EditText) findViewById(R.id.editText);
        String message = "Message from Main Activity";
